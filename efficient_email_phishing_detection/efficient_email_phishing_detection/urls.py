...
urlpatterns = [
    ...
    re_path(r'^Prediction_EMail_Phishing_Detection/$', remoteuser.Prediction_EMail_Phishing_Detection, name="Prediction_EMail_Phishing_Detection"),
    ...
    re_path(r'^Find_Predicted_EMail_Phishing_Detection_Type_Ratio/$', serviceprovider.Find_Predicted_EMail_Phishing_Detection_Type_Ratio, name="Find_Predicted_EMail_Phishing_Detection_Type_Ratio"),
    re_path(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    re_path(r'^View_Predicted_EMail_Phishing_Detection_Type/$', serviceprovider.View_Predicted_EMail_Phishing_Detection_Type, name="View_Predicted_EMail_Phishing_Detection_Type"),
